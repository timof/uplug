...
\items{
   ...
   \item Die Mitgliedschaft endet durch Austritt, Ausschluss oder Tod des Mitglieds.
%
%  der Satz ^ ist eigentlich redundant, denn Ausschluss regeln wir unten bereits explizit,
%  ebenso den Austritt (und eine Austrittsmoeglichkeit ist nach BGB verpflichtend vorgeschrieben,
%  das muessen wir auch nicht nochmal sagen, ebenso Tod, das steht auch im BGB).
%
...
\items{
  ...
  \item
    Die HG soll als \glqq eingetragene Vereinigung der Universit\"at Potsdam\grqq{} registriert werden,
    solange die Voraussetzungen der Registrierordnung in der jeweils geltenden Fassung erf\"ullt sind.
    F\"ur die Erf\"ullung von Berichts- und Auskunftspflichten, die sich aus der Registrierordnung ergeben,
    ist der Vorstand der HG zust\"andig.
}

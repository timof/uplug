...
\catcode`\@11\relax%
  \def\ps@uplug{%
    ...
    \def\@oddhead{}%
    \def\@evenhead{}%
    \def\@oddfoot{\hfill\normalfont\thepage{}\, / \the\totalpages\hfill%
...
\items{
   ...
   \item
     ...
     Fahr\-l{\"a}ssig\-keit %und der H\"ohe nach auf das Vereinsverm\"ogen (siehe BGB §31a)
     beschr{\"a}nkt.
}
...
%  \item
%    Die Mitgliederanzahl der HG muss mindestens sieben (7) betragen, anderfalls erstattet der Vorstand der HG dem Rektor der Universit{\"a}t Potsdam bzw. dessen Vertreter Bericht.
  \item
    ...
    stimmberechtigt. %Die Mittel der HG werden separat durch den Vorstand der HG verwaltet.
% {\"A}nderungen die "\S\,8 Hochschulgruppe" betreffen, sind nur durch die Mitgliedervollversammlung der HG zu {\"a}dern.
  \item
    Die HG ist w\"ahlt einen eigenen Vorstand. Sie kann auch durch Beschluss den gew\"ahlten Vereinsvorstand
    als Vorstand der HG best\"atigen.
%  \item
%    Diejenigen Mitglieder des Vereinsvorstandes, die zugleich
%    Mitglieder der HG sind, bilden den Vorstand der HG, sofern dies von der HG nichts anderes beschlie\ss{}t.
}

...
\items{
   ...
   \item Die Mitgliederversammlung ist insbesondere zust{\"a}ndig f{\"u}r
     \items{
       ...
       \item die Wahl des Vorstands;
       \item die Wahl von zwei Rechnungspr{\"u}fern;
   ...
   \item Eine au{\ss}erordentliche Mitgliederversammlung wird anberaumt
     \items{
       ...
       \item auf Verlangen der Rechnungspr{\"u}fer oder auf schriftlichen Antrag eines
   ...
   \item
    ...
    \item Antr{\"a}ge zur Tagesordnung
      \item schriftliche Antr{\"a}ge eines Zehntels der Mitglieder werden in die Tagesordnung
               aufgenommen, sofern dies unter Einhaltung der Ladefrist m{\"o}glich ist;
      \item ohne R\"ucksicht auf die Ladefrist wird die 
   ...
   \item 
     Beschlussf{\"a}higkeit
       items{
         \item Jede ordnungsgem{\"a}ss einberufene Mitgliederversammlung ist ohne R{\"u}cksicht auf
         die Anzahl der erschienenen Mitglieder beschlussf{\"a}hig.
         \item Davon abweichend erfordern Beschl{\"u}sse {\"u}ber Satzungs{\"a}nderungen oder

...
\items{
  ...
  \item
     ...
     Akzeptanz sowie die Unter\-st{\"u}tzung von Anwendern im Bereich der Datenverarbeitung
     unter spezieller
     Ber{\"u}cksichtigung des frei ver\-f{\"u}g\-baren Betriebssystems Linux.
   \item
...
\items{
   ...
   \item Ein Mitglied kann aus wichtigem Grund ausgeschlossen werden. Ein
       ...
       Aus\-schluss abgestimmt werden soll und dass die Abstimmung auch in seiner
       Abwesenheit erfolgen kann.
}
...
\items{
   \item
     ...
     Die Mitgliederversammlung kann eine h{\"o}here Anzahl von Vorstandsmitgliedern beschliessen.
   \item
...
\items{
   ...
   \item Die Mitgliederversammlung ist insbesondere zust{\"a}ndig f{\"u}r
     \items{
       ...
       \item Beschlussfassung {\"u}ber Satzungs{\"a}nderungen, Ausschluss von
                Mitgliedern und die Aufl{\"o}sung des Vereins;
       \item Beschluss einer Beitragsordnung.
     }
   ...
   \item
    ...
    \item 
      ...
      \items{
        ...
        \item auf Antrag eines Drittels der erschienenen Mitglieder der Mitgliederversammlung.
       }
   \item

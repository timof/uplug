...
\catcode`\@11\relax%
  \def\ps@uplug{%
    ...
    \def\@oddhead{}%
    \def\@evenhead{}%
    \def\@oddfoot{\par\bigskip\bigskip\par\hfill\normalfont\thepage\hfill}%
    %\def\@evenfoot{\par\bigskip\bigskip\par\hfill\normalfont\thepage\fhill}%
  }%
 \pagestyle{uplug}%
...
% {\"A}nderungen die "\S\,8 Hochschulgruppe" betreffen, sind nur durch die Mitgliedervollversammlung der HG zu {\"a}dern.
  \item
    Die HG ist berechtigt einen eigenen Vorstand zu w{\"a}hlen.
  \item
